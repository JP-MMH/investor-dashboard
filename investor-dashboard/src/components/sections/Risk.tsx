        ...
        <section id="risk" className="py-20 bg-white">
            <div className="container-custom">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-primary mb-4">Risk & Mitigation</h2>
                    <div className="w-16 h-1 bg-accent mx-auto mb-6" />
                    <p className="text-lg text-secondary/80 max-w-2xl mx-auto">
                        We believe in total transparency. Here are the key risks we have identified and how we mitigate them.
                    </p>
                </div>
                ...
                <div className="max-w-3xl mx-auto">
                    {risks.map((risk, index) => (
                        <motion.div
                            ...
                            className="mb-4"
                        >
                            <Card className="p-0 overflow-hidden border-l-4 border-l-risk">
                                <button
